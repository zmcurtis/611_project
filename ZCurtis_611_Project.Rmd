...
# FIND A BETTER WAY TO REPRESENT THIS, does not show what I predicted though 
```{r}
mean(red$fixed.acidity)
mean(white$fixed.acidity)#lower acidity than red 
mean(red$pH)
mean(white$pH) #similar pHs though 
range(red$fixed.acidity)
range(white$fixed.acidity) #narrower range but not by much 
range(red$pH)
range(white$pH) #lower pH range, more acidic ... 
```
